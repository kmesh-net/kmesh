...
type KmeshTcMarkEncryptNodeinfo struct {
	Spi    uint32
	Nodeid uint16
	_      [2]byte
}
...
// KmeshTcMarkEncryptSpecs contains programs before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
...
//
//go:embed kmeshtcmarkencrypt_bpfeb.o
