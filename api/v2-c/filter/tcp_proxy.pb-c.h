...
typedef struct _Filter__TcpProxy__WeightedCluster Filter__TcpProxy__WeightedCluster;
typedef struct _Filter__TcpProxy__WeightedCluster__ClusterWeight Filter__TcpProxy__WeightedCluster__ClusterWeight;
...
struct  _Filter__TcpProxy__WeightedCluster__ClusterWeight
{
 ...
 */
struct  _Filter__TcpProxy__WeightedCluster
{
  ProtobufCMessage base;
  /*
...
typedef enum {
  ...
  FILTER__TCP_PROXY__CLUSTER_SPECIFIER_WEIGHTED_CLUSTERS = 10
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(FILTER__TCP_PROXY__CLUSTER_SPECIFIER)
