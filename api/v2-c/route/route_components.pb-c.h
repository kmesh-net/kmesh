...
typedef struct _Route__WeightedCluster Route__WeightedCluster;
typedef struct _Route__ClusterWeight Route__ClusterWeight;
typedef struct _Route__HeaderMatcher Route__HeaderMatcher;
...
typedef enum {
  ...
  ROUTE__ROUTE_ACTION__CLUSTER_SPECIFIER_WEIGHTED_CLUSTERS = 3
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(ROUTE__ROUTE_ACTION__CLUSTER_SPECIFIER)
...
struct  _Route__WeightedCluster
{
  ProtobufCMessage base;
  size_t n_clusters;
...
typedef enum {
  ...
  ROUTE__HEADER_MATCHER__HEADER_MATCH_SPECIFIER_PREFIX_MATCH = 9
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(ROUTE__HEADER_MATCHER__HEADER_MATCH_SPECIFIER)
} Route__HeaderMatcher__HeaderMatchSpecifierCase;

struct  _Route__HeaderMatcher
{
  ProtobufCMessage base;
  /*
