...
typedef struct _Listener__Filter Listener__Filter;
typedef struct _Listener__FilterChainMatch Listener__FilterChainMatch;
typedef struct _Listener__FilterChain Listener__FilterChain;
...
typedef enum {
  ...
  LISTENER__FILTER__CONFIG_TYPE_HTTP_CONNECTION_MANAGER = 3
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(LISTENER__FILTER__CONFIG_TYPE)
} Listener__Filter__ConfigTypeCase;

struct  _Listener__Filter
{
...
struct  _Listener__FilterChainMatch
{
  ProtobufCMessage base;
