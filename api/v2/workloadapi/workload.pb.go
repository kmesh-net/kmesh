...
func (WorkloadStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_api_workloadapi_workload_proto_enumTypes[0].Descriptor()
}

func (WorkloadStatus) Type() protoreflect.EnumType {
	return &file_api_workloadapi_workload_proto_enumTypes[0]
}
...
func (WorkloadStatus) EnumDescriptor() ([]byte, []int) {
	return file_api_workloadapi_workload_proto_rawDescGZIP(), []int{0}
}
...
func (WorkloadType) Descriptor() protoreflect.EnumDescriptor {
	return file_api_workloadapi_workload_proto_enumTypes[1].Descriptor()
}

func (WorkloadType) Type() protoreflect.EnumType {
	return &file_api_workloadapi_workload_proto_enumTypes[1]
}
...
func (WorkloadType) EnumDescriptor() ([]byte, []int) {
	return file_api_workloadapi_workload_proto_rawDescGZIP(), []int{1}
}
...
func (TunnelProtocol) Descriptor() protoreflect.EnumDescriptor {
	return file_api_workloadapi_workload_proto_enumTypes[2].Descriptor()
}

func (TunnelProtocol) Type() protoreflect.EnumType {
	return &file_api_workloadapi_workload_proto_enumTypes[2]
}
...
func (TunnelProtocol) EnumDescriptor() ([]byte, []int) {
	return file_api_workloadapi_workload_proto_rawDescGZIP(), []int{2}
}
...
func (LoadBalancing_Scope) Descriptor() protoreflect.EnumDescriptor {
	return file_api_workloadapi_workload_proto_enumTypes[3].Descriptor()
}

func (LoadBalancing_Scope) Type() protoreflect.EnumType {
	return &file_api_workloadapi_workload_proto_enumTypes[3]
}
...
func (LoadBalancing_Scope) EnumDescriptor() ([]byte, []int) {
	return file_api_workloadapi_workload_proto_rawDescGZIP(), []int{2, 0}
}
...
func (LoadBalancing_Mode) Descriptor() protoreflect.EnumDescriptor {
	return file_api_workloadapi_workload_proto_enumTypes[4].Descriptor()
}

func (LoadBalancing_Mode) Type() protoreflect.EnumType {
	return &file_api_workloadapi_workload_proto_enumTypes[4]
}
...
func (LoadBalancing_Mode) EnumDescriptor() ([]byte, []int) {
	return file_api_workloadapi_workload_proto_rawDescGZIP(), []int{2, 1}
}
...
func (ApplicationTunnel_Protocol) Descriptor() protoreflect.EnumDescriptor {
	return file_api_workloadapi_workload_proto_enumTypes[5].Descriptor()
}

func (ApplicationTunnel_Protocol) Type() protoreflect.EnumType {
	return &file_api_workloadapi_workload_proto_enumTypes[5]
}
...
func (ApplicationTunnel_Protocol) EnumDescriptor() ([]byte, []int) {
	return file_api_workloadapi_workload_proto_rawDescGZIP(), []int{7, 0}
}
...
func (x *Address) Reset() {
	*x = Address{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_workloadapi_workload_proto_msgTypes[0]
...
func (x *Service) Reset() {
	*x = Service{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_workloadapi_workload_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
type LoadBalancing struct {
	...
	RoutingPreference []LoadBalancing_Scope `protobuf:"varint,1,rep,packed,name=routing_preference,json=routingPreference,proto3,enum=workload.LoadBalancing_Scope" json:"routing_preference,omitempty"`
	// mode defines how we should handle the routing preferences.
	Mode LoadBalancing_Mode `protobuf:"varint,2,opt,name=mode,proto3,enum=workload.LoadBalancing_Mode" json:"mode,omitempty"`
}

func (x *LoadBalancing) Reset() {
	*x = LoadBalancing{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_workloadapi_workload_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
type Workload struct {
	...
	TunnelProtocol TunnelProtocol `protobuf:"varint,5,opt,name=tunnel_protocol,json=tunnelProtocol,proto3,enum=workload.TunnelProtocol" json:"tunnel_protocol,omitempty"`
	...
	WorkloadType WorkloadType `protobuf:"varint,12,opt,name=workload_type,json=workloadType,proto3,enum=workload.WorkloadType" json:"workload_type,omitempty"`
	...
	Status                WorkloadStatus `protobuf:"varint,17,opt,name=status,proto3,enum=workload.WorkloadStatus" json:"status,omitempty"`
...
func (x *Workload) Reset() {
	*x = Workload{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_workloadapi_workload_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Workload) Descriptor() ([]byte, []int) {
	return file_api_workloadapi_workload_proto_rawDescGZIP(), []int{3}
}
...
func (x *Locality) Reset() {
	*x = Locality{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_workloadapi_workload_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Locality) Descriptor() ([]byte, []int) {
	return file_api_workloadapi_workload_proto_rawDescGZIP(), []int{4}
}
...
func (x *PortList) Reset() {
	*x = PortList{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_workloadapi_workload_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PortList) Descriptor() ([]byte, []int) {
	return file_api_workloadapi_workload_proto_rawDescGZIP(), []int{5}
}
...
func (x *Port) Reset() {
	*x = Port{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_workloadapi_workload_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Port) Descriptor() ([]byte, []int) {
	return file_api_workloadapi_workload_proto_rawDescGZIP(), []int{6}
}
...
type ApplicationTunnel struct {
	...
	Protocol ApplicationTunnel_Protocol `protobuf:"varint,1,opt,name=protocol,proto3,enum=workload.ApplicationTunnel_Protocol" json:"protocol,omitempty"`
...
func (x *ApplicationTunnel) Reset() {
	*x = ApplicationTunnel{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_workloadapi_workload_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ApplicationTunnel) Descriptor() ([]byte, []int) {
	return file_api_workloadapi_workload_proto_rawDescGZIP(), []int{7}
}
...
func (x *GatewayAddress) Reset() {
	*x = GatewayAddress{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_workloadapi_workload_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GatewayAddress) Descriptor() ([]byte, []int) {
	return file_api_workloadapi_workload_proto_rawDescGZIP(), []int{8}
}
...
func (x *NetworkAddress) Reset() {
	*x = NetworkAddress{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_workloadapi_workload_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*NetworkAddress) Descriptor() ([]byte, []int) {
	return file_api_workloadapi_workload_proto_rawDescGZIP(), []int{9}
}
...
func (x *NamespacedHostname) Reset() {
	*x = NamespacedHostname{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_workloadapi_workload_proto_msgTypes[10]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*NamespacedHostname) Descriptor() ([]byte, []int) {
	return file_api_workloadapi_workload_proto_rawDescGZIP(), []int{10}
}
...
var File_api_workloadapi_workload_proto protoreflect.FileDescriptor

var file_api_workloadapi_workload_proto_rawDesc = []byte{
	,
	...
	0x68, 0x6f, 0x73, 0x74, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x36, 0x0a, 0x09, 0x61, 0x64, 0x64, 0x72,
	0x65, 0x73, 0x73, 0x65, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x77, 0x6f,
	...
	,
	...
	0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x12, 0x30, 0x0a, 0x04, 0x6d, 0x6f, 0x64, 0x65,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1c, 0x2e, 0x77, 0x6f, 0x72, 0x6b, 0x6c, 0x6f, 0x61,
	0x64, 0x2e, 0x4c, 0x6f, 0x61, 0x64, 0x42, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x69, 0x6e, 0x67, 0x2e,
	0x4d, 0x6f, 0x64, 0x65, 0x52, 0x04, 0x6d, 0x6f, 0x64, 0x65, 0x22, 0x65, 0x0a, 0x05, 0x53, 0x63,
	...
	0x41, 0x49, 0x4c, 0x4f, 0x56, 0x45, 0x52, 0x10, 0x02, 0x22, 0xb4, 0x08, 0x0a, 0x08, 0x57, 0x6f,
	...
	0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x12, 0x41,
	0x0a, 0x0f, 0x74, 0x75, 0x6e, 0x6e, 0x65, 0x6c, 0x5f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f,
	0x6c, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x18, 0x2e, 0x77, 0x6f, 0x72, 0x6b, 0x6c, 0x6f,
	...
	,
	...
	0x6d, 0x65, 0x12, 0x23, 0x0a, 0x0d, 0x6e, 0x61, 0x74, 0x69, 0x76, 0x65, 0x5f, 0x74, 0x75, 0x6e,
	0x6e, 0x65, 0x6c, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0c, 0x6e, 0x61, 0x74, 0x69, 0x76,
	0x65, 0x54, 0x75, 0x6e, 0x6e, 0x65, 0x6c, 0x12, 0x4a, 0x0a, 0x12, 0x61, 0x70, 0x70, 0x6c, 0x69,
	0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x74, 0x75, 0x6e, 0x6e, 0x65, 0x6c, 0x18, 0x17, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x77, 0x6f, 0x72, 0x6b, 0x6c, 0x6f, 0x61, 0x64, 0x2e, 0x41,
	...
	0x6e, 0x65, 0x6c, 0x12, 0x3c, 0x0a, 0x08, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x18,
	0x16, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x20, 0x2e, 0x77, 0x6f, 0x72, 0x6b, 0x6c, 0x6f, 0x61, 0x64,
	0x2e, 0x57, 0x6f, 0x72, 0x6b, 0x6c, 0x6f, 0x61, 0x64, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	...
	0x6f, 0x6e, 0x5f, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x69, 0x65, 0x73, 0x18, 0x10, 0x20, 0x03, 0x28,
	0x09, 0x52, 0x15, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	0x50, 0x6f, 0x6c, 0x69, 0x63, 0x69, 0x65, 0x73, 0x12, 0x30, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74,
	0x75, 0x73, 0x18, 0x11, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x18, 0x2e, 0x77, 0x6f, 0x72, 0x6b, 0x6c,
	...
	0x63, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x49, 0x64, 0x12, 0x2e, 0x0a, 0x08, 0x6c, 0x6f, 0x63,
	0x61, 0x6c, 0x69, 0x74, 0x79, 0x18, 0x18, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x77, 0x6f,
	0x72, 0x6b, 0x6c, 0x6f, 0x61, 0x64, 0x2e, 0x4c, 0x6f, 0x63, 0x61, 0x6c, 0x69, 0x74, 0x79, 0x52,
	0x08, 0x6c, 0x6f, 0x63, 0x61, 0x6c, 0x69, 0x74, 0x79, 0x1a, 0x4f, 0x0a, 0x0d, 0x53, 0x65, 0x72,
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x77, 0x6f,
	0x72, 0x6b, 0x6c, 0x6f, 0x61, 0x64, 0x2e, 0x50, 0x6f, 0x72, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x52,
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x4a, 0x04, 0x08, 0x0f, 0x10, 0x10,
	0x22, 0x50, 0x0a, 0x08, 0x4c, 0x6f, 0x63, 0x61, 0x6c, 0x69, 0x74, 0x79, 0x12, 0x16, 0x0a, 0x06,
	...
	0x28, 0x09, 0x52, 0x04, 0x7a, 0x6f, 0x6e, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x73, 0x75, 0x62, 0x7a,
	0x6f, 0x6e, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x73, 0x75, 0x62, 0x7a, 0x6f,
	0x6e, 0x65, 0x22, 0x30, 0x0a, 0x08, 0x50, 0x6f, 0x72, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x24,
	0x0a, 0x05, 0x70, 0x6f, 0x72, 0x74, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0e, 0x2e,
	...
	,
	...
	0x42, 0x4f, 0x4e, 0x45, 0x10, 0x01, 0x42, 0x2d, 0x5a, 0x2b, 0x6b, 0x6d, 0x65, 0x73, 0x68, 0x2e,
	0x6e, 0x65, 0x74, 0x2f, 0x6b, 0x6d, 0x65, 0x73, 0x68, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x77, 0x6f,
	0x72, 0x6b, 0x6c, 0x6f, 0x61, 0x64, 0x61, 0x70, 0x69, 0x3b, 0x77, 0x6f, 0x72, 0x6b, 0x6c, 0x6f,
	0x61, 0x64, 0x61, 0x70, 0x69, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_api_workloadapi_workload_proto_rawDescOnce sync.Once
	file_api_workloadapi_workload_proto_rawDescData = file_api_workloadapi_workload_proto_rawDesc
)

func file_api_workloadapi_workload_proto_rawDescGZIP() []byte {
	file_api_workloadapi_workload_proto_rawDescOnce.Do(func() {
		file_api_workloadapi_workload_proto_rawDescData = protoimpl.X.CompressGZIP(file_api_workloadapi_workload_proto_rawDescData)
	})
	return file_api_workloadapi_workload_proto_rawDescData
}

var file_api_workloadapi_workload_proto_enumTypes = make([]protoimpl.EnumInfo, 6)
var file_api_workloadapi_workload_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_api_workloadapi_workload_proto_goTypes = []interface{}{
	(WorkloadStatus)(0),             // 0: workload.WorkloadStatus
	(WorkloadType)(0),               // 1: workload.WorkloadType
	(TunnelProtocol)(0),             // 2: workload.TunnelProtocol
	(LoadBalancing_Scope)(0),        // 3: workload.LoadBalancing.Scope
	(LoadBalancing_Mode)(0),         // 4: workload.LoadBalancing.Mode
	(ApplicationTunnel_Protocol)(0), // 5: workload.ApplicationTunnel.Protocol
	(*Address)(nil),                 // 6: workload.Address
	(*Service)(nil),                 // 7: workload.Service
	(*LoadBalancing)(nil),           // 8: workload.LoadBalancing
	(*Workload)(nil),                // 9: workload.Workload
	(*Locality)(nil),                // 10: workload.Locality
	(*PortList)(nil),                // 11: workload.PortList
	(*Port)(nil),                    // 12: workload.Port
	(*ApplicationTunnel)(nil),       // 13: workload.ApplicationTunnel
	(*GatewayAddress)(nil),          // 14: workload.GatewayAddress
	(*NetworkAddress)(nil),          // 15: workload.NetworkAddress
	(*NamespacedHostname)(nil),      // 16: workload.NamespacedHostname
	nil,                             // 17: workload.Workload.ServicesEntry
}
var file_api_workloadapi_workload_proto_depIdxs = []int32{
	9,  // 0: workload.Address.workload:type_name -> workload.Workload
	7,  // 1: workload.Address.service:type_name -> workload.Service
	15, // 2: workload.Service.addresses:type_name -> workload.NetworkAddress
	12, // 3: workload.Service.ports:type_name -> workload.Port
	14, // 4: workload.Service.waypoint:type_name -> workload.GatewayAddress
	8,  // 5: workload.Service.load_balancing:type_name -> workload.LoadBalancing
	3,  // 6: workload.LoadBalancing.routing_preference:type_name -> workload.LoadBalancing.Scope
	4,  // 7: workload.LoadBalancing.mode:type_name -> workload.LoadBalancing.Mode
	2,  // 8: workload.Workload.tunnel_protocol:type_name -> workload.TunnelProtocol
	14, // 9: workload.Workload.waypoint:type_name -> workload.GatewayAddress
	14, // 10: workload.Workload.network_gateway:type_name -> workload.GatewayAddress
	1,  // 11: workload.Workload.workload_type:type_name -> workload.WorkloadType
	13, // 12: workload.Workload.application_tunnel:type_name -> workload.ApplicationTunnel
	17, // 13: workload.Workload.services:type_name -> workload.Workload.ServicesEntry
	0,  // 14: workload.Workload.status:type_name -> workload.WorkloadStatus
	10, // 15: workload.Workload.locality:type_name -> workload.Locality
	12, // 16: workload.PortList.ports:type_name -> workload.Port
	5,  // 17: workload.ApplicationTunnel.protocol:type_name -> workload.ApplicationTunnel.Protocol
	16, // 18: workload.GatewayAddress.hostname:type_name -> workload.NamespacedHostname
	15, // 19: workload.GatewayAddress.address:type_name -> workload.NetworkAddress
	11, // 20: workload.Workload.ServicesEntry.value:type_name -> workload.PortList
...
func init() { file_api_workloadapi_workload_proto_init() }
func file_api_workloadapi_workload_proto_init() {
	if File_api_workloadapi_workload_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_api_workloadapi_workload_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_workloadapi_workload_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_workloadapi_workload_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_workloadapi_workload_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_workloadapi_workload_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_workloadapi_workload_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_workloadapi_workload_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Port); i {
			case 0:
				return &v.state
			case 1:
		...
		file_api_workloadapi_workload_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_workloadapi_workload_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_workloadapi_workload_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_workloadapi_workload_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
	...
	file_api_workloadapi_workload_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*Address_Workload)(nil),
		(*Address_Service)(nil),
	}
	file_api_workloadapi_workload_proto_msgTypes[8].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_api_workloadapi_workload_proto_rawDesc,
			NumEnums:      6,
			NumMessages:   12,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_api_workloadapi_workload_proto_goTypes,
		DependencyIndexes: file_api_workloadapi_workload_proto_depIdxs,
		EnumInfos:         file_api_workloadapi_workload_proto_enumTypes,
		MessageInfos:      file_api_workloadapi_workload_proto_msgTypes,
	}.Build()
	File_api_workloadapi_workload_proto = out.File
	file_api_workloadapi_workload_proto_rawDesc = nil
	file_api_workloadapi_workload_proto_goTypes = nil
	file_api_workloadapi_workload_proto_depIdxs = nil
}
