...
typedef struct _Endpoint__Endpoint Endpoint__Endpoint;
typedef struct _Endpoint__LocalityLbEndpoints Endpoint__LocalityLbEndpoints;
typedef struct _Endpoint__ClusterLoadAssignment Endpoint__ClusterLoadAssignment;
...
struct  _Endpoint__LocalityLbEndpoints
{
  ProtobufCMessage base;
...
struct  _Endpoint__ClusterLoadAssignment
{
  ProtobufCMessage base;
  char *cluster_name;
  size_t n_endpoints;
