...
func Execute(configs *options.BootstrapConfigs) error {
	...
	c := controller.NewController(configs, bpfLoader.GetBpfKmesh(), bpfLoader.GetBpfWorkload(), configs.BpfConfig.BpfFsPath, configs.BpfConfig.EnableBpfLog, configs.BpfConfig.EnableAccesslog, configs.BpfConfig.EnableIpsec)
